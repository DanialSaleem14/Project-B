---
title: "Cambridge IELTS Book 20 Test 3 Reading Answers"
url: "/answers/cambridge-20-test-3/"
date: 2024-01-01
layout: "single"
type: "page"
description: "Get the complete and verified IELTS Reading Answers for Cambridge Book 20 Test 3. Prepare for your exam with accurate keys."
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="text-center mb-10">
        <h1 class="text-3xl md:text-4xl font-display font-extrabold text-slate-900 mb-4">Cambridge Book 20 Test 3</h1>
    ...
    <table class="w-full text-sm text-left text-slate-600">
        ...
        <tbody class="bg-white divide-y divide-slate-100">
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">potatoes</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">2</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">butter</td>
            </tr>
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">crystals</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">5</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">cellophane</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">6</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">tin</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">7</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">refrigerator</td>
            </tr>
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">adaptation</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">32</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">cognitive</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">33</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">desks</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">34</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">taps</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">35</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">blue</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">36</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">voice</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">37</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">pregnant</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">38</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">shoulders</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">39</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">police</td>
            </tr>
