---
title: "Cambridge IELTS Book 18 Test 2 Reading Answers"
url: "/answers/cambridge-18-test-2/"
date: 2024-01-01
layout: "single"
type: "page"
description: "Get the complete and verified IELTS Reading Answers for Cambridge Book 18 Test 2. Prepare for your exam with accurate keys."
keywords: ["IELTS, IELTS Reading, Cambridge IELTS, IELTS Answer Key, IELTS Exam Preparation, IELTS Test 18, Cambridge Reading Answers, Free IELTS Material, British Council IELTS, IDP IELTS, Academic Reading, General Training Reading"]
---

<div class="max-w-4xl mx-auto">

    <div class="text-center mb-10">
        <h1 class="text-3xl md:text-4xl font-display font-extrabold text-slate-900 mb-4">Cambridge Book 18 Test 2</h1>
    ...
    <table class="w-full text-sm text-left text-slate-600">
        ...
        <tbody class="bg-white divide-y divide-slate-100">
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">(deer) antlers</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">2</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">(timber) posts</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">3</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">tree trunks</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">4</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">oxen</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">5</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">glaciers</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">6</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">Druids</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">7</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">burial</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">8</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">calendar</td>
            </tr>
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">resources</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">25</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">students</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">26</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">doctors</td>
            </tr>
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">disordered</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">35</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">reconstructed</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">36</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">transport</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">37</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">clean</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">38</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">stairs</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">39</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">wheels</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">40</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">roads</td>
            </tr>
