---
title: "Cambridge IELTS Book 20 Test 2 Reading Answers"
url: "/answers/cambridge-20-test-2/"
date: 2024-01-01
layout: "single"
type: "page"
description: "Get the complete and verified IELTS Reading Answers for Cambridge Book 20 Test 2. Prepare for your exam with accurate keys."
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="text-center mb-10">
        <h1 class="text-3xl md:text-4xl font-display font-extrabold text-slate-900 mb-4">Cambridge Book 20 Test 2</h1>
    ...
    <table class="w-full text-sm text-left text-slate-600">
        ...
        <tbody class="bg-white divide-y divide-slate-100">
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">flippers</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">3</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">hair</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">4</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">seagrasses</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">5</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">lips</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">6</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">buoyancy</td>
            </tr>
            ...
            <tr class="hover:bg-blue-50/50 transition-colors">
                ...
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">laziness</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">15</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">anxious</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">16</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">threats</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">17</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">exams</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">18</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">perfectionists</td>
            </tr>

            <tr class="hover:bg-blue-50/50 transition-colors">
                <td class="px-6 py-4 font-medium text-slate-900 border-r border-slate-50">19</td>
                <td class="px-6 py-4 font-bold text-primary text-center tracking-wide">guilt</td>
            </tr>
